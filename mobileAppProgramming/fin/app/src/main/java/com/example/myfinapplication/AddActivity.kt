...
import com.example.myfinapplication.databinding.ActivityAddBinding
import java.io.File
...
class AddActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val bgColor:String? = sharedPreferences.getString("add_bg_color", "#FFFFFF")
        binding.btnGallery.setBackgroundColor(Color.parseColor(bgColor))
        binding.btnSave.setBackgroundColor(Color.parseColor(bgColor))
        val txColor:String? = sharedPreferences.getString("add_tx_color", "#000000")
        binding.btnGallery.setTextColor(Color.parseColor(txColor))
        binding.btnSave.setTextColor(Color.parseColor(txColor))

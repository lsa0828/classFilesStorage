...
import com.example.myfinapplication.databinding.FragmentThreeBinding
import com.example.myfinapplication.databinding.FragmentTwoBinding
...
class ThreeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.btnSearch?.setOnClickListener{
            val call: Call<MyModel> = MyApplication.networkService2.getList(
                "mPJK7sLRO8SbE1WXIsOcFuGFnHelM2sHukbSUGmFYvuIUAfXKrdHA8eLwztFpvjFEyZk6mvsb2js3sJi6t18NA==",
                1,
                10,
                "json"
            )

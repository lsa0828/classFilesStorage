...
class Panorama(QMainWindow):
    ...
    def collectFunction(self):
        ...
        self.cap=cv.VideoCapture('scene.mp4')
        ...
        while True:
            ...
            cv.imshow('video display', cv.resize(frame,dsize=(0,0),fx=0.5,fy=0.5))
    ...
    def stitchFunction(self):
        ...
        if status == cv.STITCHER_OK:
            cv.imshow('Image stitched panorama', cv.resize(self.img_stitched,dsize=(0,0),fx=0.5,fy=0.5))
        else:
